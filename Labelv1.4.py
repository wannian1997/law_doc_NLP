...
class Ui_MainWindow(object):
    ...
    def number2word(self, textlist):
        ...
        for t in textlist:
            if t[-2:-1] == "\t":
                ...
                # num = len(self.listfronttostr(self.display_text[-1:],1)) - len(t)
    ...
    def tagging(self, index, index_list_num, label_list):
        self.display_text[index] = self.textdispose2(self.display_text[index], label_list[index_list_num], 0) # 在前台数据打标签
    ...
    def label0(self):
        ...
        if lab0:
            if self.linenum <= len(self.display_text) - 1:
                ...
                if num == 0:
                    self.display_text[self.linenum - 1] = self.textdispose2(self.display_text[self.linenum - 1], lab0, 0)
                    self.back_text[self.linenum - 1] = self.textdispose(self.back_text[self.linenum - 1], 0, 0)
                else:
                    self.display_text[self.linenum - 1] = self.textdispose2(self.display_text[self.linenum - 1], lab0, num+1)
    ...
    def label1(self):
        ...
        if lab1:
            if self.linenum <= len(self.display_text) - 1:
                num = len(self.display_text[self.linenum - 1]) - len(self.back_text[self.linenum - 1])
                if num == 0:
                    self.display_text[self.linenum - 1] = self.textdispose2(self.display_text[self.linenum - 1], lab1, 0)
                    self.back_text[self.linenum - 1] = self.textdispose(self.back_text[self.linenum - 1], 1, 0)
                else:
                    self.display_text[self.linenum - 1] = self.textdispose2(self.display_text[self.linenum - 1], lab1, num + 1)
    ...
    def label2(self):
        ...
        if lab2:
            if self.linenum <= len(self.display_text) - 1:
                num = len(self.display_text[self.linenum - 1]) - len(self.back_text[self.linenum - 1])
                if num == 0:
                    self.display_text[self.linenum - 1] = self.textdispose2(self.display_text[self.linenum - 1], lab2, 0)
    ...
    def label3(self):
        ...
        if lab3:
            if self.linenum <= len(self.display_text) - 1:
                num = len(self.display_text[self.linenum - 1]) - len(self.back_text[self.linenum - 1])
                if num == 0:
                    self.display_text[self.linenum - 1] = self.textdispose2(self.display_text[self.linenum - 1], lab3, 0)
    ...
    def label4(self):
        ...
        if lab4:
            if self.linenum <= len(self.display_text) - 1:
                num = len(self.display_text[self.linenum - 1]) - len(self.back_text[self.linenum - 1])
                if num == 0:
                    self.display_text[self.linenum - 1] = self.textdispose2(self.display_text[self.linenum - 1], lab4, 0)
    ...
    def label5(self):
        ...
        if lab5:
            if self.linenum <= len(self.display_text) - 1:
                num = len(self.display_text[self.linenum - 1]) - len(self.back_text[self.linenum - 1])
                if num == 0:
                    self.display_text[self.linenum - 1] = self.textdispose2(self.display_text[self.linenum - 1], lab5, 0)
    ...
    def label6(self):
        ...
        if lab6:
            if self.linenum <= len(self.display_text) - 1:
                num = len(self.display_text[self.linenum - 1]) - len(self.back_text[self.linenum - 1])
                if num == 0:
                    self.display_text[self.linenum - 1] = self.textdispose2(self.display_text[self.linenum - 1], lab6, 0)
    ...
    def label7(self):
        ...
        if lab7:
            if self.linenum <= len(self.display_text) - 1:
                num = len(self.display_text[self.linenum - 1]) - len(self.back_text[self.linenum - 1])
                if num == 0:
                    self.display_text[self.linenum - 1] = self.textdispose2(self.display_text[self.linenum - 1], lab7, 0)
    ...
    def label8(self):
        ...
        if lab8:
            if self.linenum <= len(self.display_text) - 1:
                num = len(self.display_text[self.linenum - 1]) - len(self.back_text[self.linenum - 1])
                if num == 0:
                    self.display_text[self.linenum - 1] = self.textdispose2(self.display_text[self.linenum - 1], lab8, 0)
    ...
    def label9(self):
        ...
        if lab9:
            if self.linenum <= len(self.display_text) - 1:
                num = len(self.display_text[self.linenum - 1]) - len(self.back_text[self.linenum - 1])
                if num == 0:
                    self.display_text[self.linenum - 1] = self.textdispose2(self.display_text[self.linenum - 1], lab9, 0)
    ...
    def label10(self):
        ...
        if lab10:
            if self.linenum <= len(self.display_text) - 1:
                num = len(self.display_text[self.linenum - 1]) - len(self.back_text[self.linenum - 1])
                if num == 0:
                    self.display_text[self.linenum - 1] = self.textdispose2(self.display_text[self.linenum - 1], lab10, 0)
                    self.back_text[self.linenum - 1] = self.textdispose(self.back_text[self.linenum - 1], 10, 0)
                else:
                    self.display_text[self.linenum - 1] = self.textdispose2(self.display_text[self.linenum - 1], lab10, num + 1)
    ...
    def label11(self):
        ...
        if lab11:
            if self.linenum <= len(self.display_text) - 1:
                num = len(self.display_text[self.linenum - 1]) - len(self.back_text[self.linenum - 1])
                if num == 0:
                    self.display_text[self.linenum - 1] = self.textdispose2(self.display_text[self.linenum - 1], lab11, 0)
                    self.back_text[self.linenum - 1] = self.textdispose(self.back_text[self.linenum - 1], 11, 0)
                else:
                    self.display_text[self.linenum - 1] = self.textdispose2(self.display_text[self.linenum - 1], lab11, num + 1)
    ...
    def label12(self):
        ...
        if lab12:
            if self.linenum <= len(self.display_text) - 1:
                num = len(self.display_text[self.linenum - 1]) - len(self.back_text[self.linenum - 1])
                if num == 0:
                    self.display_text[self.linenum - 1] = self.textdispose2(self.display_text[self.linenum - 1], lab12, 0)
                    self.back_text[self.linenum - 1] = self.textdispose(self.back_text[self.linenum - 1], 12, 0)
                else:
                    self.display_text[self.linenum - 1] = self.textdispose2(self.display_text[self.linenum - 1], lab12, num + 1)
    ...
    def label13(self):
        ...
        if lab13:
            if self.linenum <= len(self.display_text) - 1:
                num = len(self.display_text[self.linenum - 1]) - len(self.back_text[self.linenum - 1])
                if num == 0:
                    self.display_text[self.linenum - 1] = self.textdispose2(self.display_text[self.linenum - 1], lab13, 0)
                    self.back_text[self.linenum - 1] = self.textdispose(self.back_text[self.linenum - 1], 13, 0)
                else:
                    self.display_text[self.linenum - 1] = self.textdispose2(self.display_text[self.linenum - 1], lab13, num + 1)
    ...
    def label14(self):
        ...
        if lab14:
            if self.linenum <= len(self.display_text) - 1:
                num = len(self.display_text[self.linenum - 1]) - len(self.back_text[self.linenum - 1])
                if num == 0:
                    self.display_text[self.linenum - 1] = self.textdispose2(self.display_text[self.linenum - 1], lab14, 0)
                    self.back_text[self.linenum - 1] = self.textdispose(self.back_text[self.linenum - 1], 14, 0)
                else:
                    self.display_text[self.linenum - 1] = self.textdispose2(self.display_text[self.linenum - 1], lab14, num + 1)
